...
<body>
	<div>
																		...
																		<div class="row">
																			...
																			<div class="form-group">
																				<div class="col-md-6">
																					...
																					<div>
																						<h1>英雄故事</h1>
																						<textarea id="editor1" name="story" rows="15"
																							cols="80"></textarea>
																					</div>
																				...
																				<div class="col-md-6">
																					...
																					<div>
																						<input type="hidden" name="pictureImg"
																							id="pictureImg" /> <input id="photo" type="file"
																							onchange="filespload()" class="file" /> <img
																							src="" name="pic" id="pic"
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/assets/plugins/ckeditor/ckeditor.js"></script>
		<script
