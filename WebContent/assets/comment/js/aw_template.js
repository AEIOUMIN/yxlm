				...
				'<div class="modal-content">'+
					...
					'<form id="favorite_form" action="' + G_BASE_URL + '/favorite/ajax/update_favorite_tag/" method="post" onsubmit="return false;">'+
						...
						'<div class="mod aw-favorite-tag-list">'+
							...
							'</div>'+
							'<div class="modal-footer">'+
								'<a class="pull-left" onclick="$(\'.aw-favorite-box .aw-favorite-tag-list\').hide();$(\'.aw-favorite-box .aw-favorite-tag-add\').show();">' + _t('鍒涘缓鏍囩') + '</a>'+
								'<button href="javascript:;"  data-dismiss="modal" aria-hidden="true" class="btn btn-large btn-gray">' + _t('鍙栨秷') + '</button>'+
							'</div>'+
						'</div>'+
						'<div class="mod aw-favorite-tag-add hide">'+
							'<div class="modal-body">'+
								'<input type="text" class="form-control add-input" placeholder="' + _t('鏍囩鍚嶅瓧') + '" />'+
							'</div>'+
							'<div class="modal-footer">'+
								'<a onclick="$(\'.aw-favorite-box .aw-favorite-tag-list\').show();$(\'.aw-favorite-box .aw-favorite-tag-add\').hide();">' + _t('鍙栨秷') + '</a>'+
								'<button href="javascript:;" class="btn btn-large btn-success" onclick="AWS.User.add_favorite_tag()">' + _t('纭鍒涘缓') + '</button>'+
							'</div>'+
						'</div>'+
					'</form>'+
				'</div>'+
