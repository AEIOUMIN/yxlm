	        	...
	        	switch (type)
	        	{
					...
					case 'reply':
						...
						if (result.rsm.ajax_html)
						{
							...
							$('.aw-replay-box').append('<p align="center">涓€涓棶棰樺彧鑳藉洖澶嶄竴娆�, 浣犲彲浠ュ湪鍙戣█鍚� 640000 鍒嗛挓鍐呯紪杈戝洖澶嶈繃鐨勫唴瀹�</p>');
						}
	...
	add_multimedia: function (type)
	{
		switch (type){
			case 'img' :
				var title = 'imgsAlt',
					url = 'imgsUrl',
					textFeildValue = '![璇疯緭鍏ュ浘鐗囧悕瀛梋(' + $('#addTxtForms :input[name="' + url + '"]').val() + ')';
			break;
